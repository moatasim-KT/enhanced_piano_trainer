...
from temp_midi_processing.midi_loader import MidiLoader
from ui.piano_view import PianoView
from temp_audio.sound_engine import SoundEngine
...
class ScalePractice(PracticeMode):
    ...
    def highlight_scale_notes(self):
